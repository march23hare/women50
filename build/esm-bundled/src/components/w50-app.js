...
`;var sharedAStyles={SharedAStyles:SharedAStyles};const SharedLiStyles=html`
<style>
  li {
    list-style: none;
  }
</style>
`;var sharedLiStyles={SharedLiStyles:SharedLiStyles};const SharedRHiddenStyles=html`
<style>
  .readable-hidden {
    display: block;
    clip-path: inset(100%);
...
`;var sharedRhiddenStyles={SharedRHiddenStyles:SharedRHiddenStyles};const SharedStyles=html`
<style>
  :host {
    display: block;
...
`;var sharedStyles={SharedStyles:SharedStyles};class W50404 extends LitElement{render(){return html`
      <p>존재하지 않는 경로 입니다.</p>
    `}}customElements.define("w50-404",W50404);class W50NavItem extends LitElement{static get properties(){return{path:{type:Number},caption:{type:String},isCurrent:{type:Boolean},num:{type:Number}}}constructor(){super()}onChangePart(pt){this.dispatchEvent(new CustomEvent("changePart",{bubbles:!0,composed:!0,detail:{part:pt}}))}render(){return html`
    ${SharedStyles}
    ${SharedAStyles}
