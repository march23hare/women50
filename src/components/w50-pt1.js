  ...
  render() {
    ...
    <main class="main">
      ...
      <section>
        ...
        <figure>
          <picture>
            <img src="images/wordcloud1-01.png" alt="word cloud">
          </picture>
          <figcaption>그림 1. 워드 크라우드로 드러난 중년의 속마음</figcaption>
        </figure>
      ...
      <section>
        ...
        <p>저성장, 고령화 시대에 퇴직은 앞당겨지고, 취업, 결혼, 자립이 늦어지는 자녀와 부모 부양을 위한 경제적 부담은 증가한 것도 중년 여성들을 힘들게 한다. 일산에 거주하는 유혜수(53세, 자영업) 씨가 은퇴를 고려할 시기에 스트레스와 부담감을 안고 새로운 사업을 시작한 이유도 여기에 있다.</p>
        <p>"요즘 세대들은 바늘 구멍을 뚫고 취업을 해도, 현실적으로 홀로 서기가 어려운 상황이잖아요. 아무리 월급을 꾸준히 모아도 집 한 채 살 돈조차 모으기 힘든 게 현실이니까. 남편도 저도 건강이 썩 좋은 상황은 아니지만 우리 노후보단 아이들의 미래를 위해 가족 사업을 시작했어요. 설상가상으로 친정 어머니가 병환으로 요양원에 계시는데, 그 병원비를 감당하는 것도 만만치 않고요. 오히려 지금 아이들이 한창 크는 30-40대 때 보다 더 많은 돈이 필요한 것 같아요."</p>
        <p>정신의학 전문의 박종석 원장은 독립기 자녀와의 관계 단절로 인해 허무함, 공허함 등을 느끼는 빈둥지 증후군을 극복하는 법에 대해 다음과 같은 방법을 알려준다.</p>
        <p>"우울감을 호소하는 대부분의 50대 중년 여성의 대부분은 급격하게 일어나는 변화를 생의 새로운 전환점으로 받아들이는 대신 스트레스를 유발 요소로 인식합니다. 또 자녀가 성인으로서 책임감을 가질 준비가 돼있지 않다고 생각할수록 더 깊은 우울감을 느끼기도 합니다. 이런 경우 자녀와의 감정적 분리가 우선적으로 필요합니다. 엄마로서의 삶 이외에 중년기, 노년기에 하고 싶은 일, 삶의 버킷 리스트 등을 반드시 만들어야 하며, 이를 위한 단기 계획, 장기 계획을 세워 하나씩 실천해나가야 합니다."</p>
        <a class="jump" href="ch3.html">
          <span>로젠버그의 자아존중감 테스트로</span>
          <span>나를 들여다 보세요</span>
          <span class="description">테스트 하러가기</span>
        </a>
        <p>박종석 원장은 갱년기의 스트레스, 불안을 공유할 수 있는 또래 집단과의 커뮤니티 활동을 통해 부정적인 감정을 바로 바로 해소하는 것도 중요하다고 말한다.</p>
        <p>특히 기분 장애의 대표질환인 우울증 평생 유병율이 남성보다 2배 이상 더 높은 여성의 경우 (보건 복지부가 시행한 2016년도 정신질환실태 역학조사 결과는 남성은 3% 여성은 6.9%였다) 이러한 감정에 좀 더 기민하게 응할 필요가 있다.</p>
        <p>"자녀 양육과 가사에 매진한 전업 주부의 경우 마치 정년 퇴임한 가장처럼 '이제 내가 뭘 하며 살아야 하지?'라는 의문에서 오는 고독감, 가정에서 내 역할이 사라졌다는 상실감 등으로 우울감을 느끼게 됩니다. 이 감정이 일시적이라면 약 6개월 정도 안에 자신의 새로운 관심사, 일, 취미 등을 찾아 조금씩 자연스럽게 극복할 수 있습니다. 만약 우울감이 1년 이상 지속되거나 잠을 잘 못자고 아무것도 하고 싶지 않을 정도로 무기력하다면 상담센터나 병원을 찾아 전문가의 진단을 받아보는 것이 필요합니다."</p>
      </section>
      <section>
